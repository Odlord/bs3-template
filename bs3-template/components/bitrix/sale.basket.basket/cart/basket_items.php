...
if ($normalCount > 0):
?>
<div id="basket_items_list" class="cart-page">
	<div class="bx_ordercart_order_table_container">
		<table id="basket_items" class="cart-tbl">
			<thead>
				<tr class="cart-tr">
					<td class="margin"></td>
					<?
					...
					<tr id="<?=$arItem["ID"]?>" class="cart-tr">
						...
						foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
							...
							?>
								<td class="custom">
									...
									if ($arHeader["id"] == "SUM"):
									?>
										<div class="cart-summ" id="sum_<?=$arItem["ID"]?>">
									<?
									endif;
						...
						?>
							<td class="control actions">
								...
								if ($bDeleteColumn):
								?>
									<a class="action-del" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"><?=GetMessage("SALE_DELETE")?></a><br />
								<?
								endif;
								if ($bDelayColumn):
								?>
									<a class="" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delay"])?>"><?=GetMessage("SALE_DELAY")?></a>
								<?
								endif;
								?>
							</td>
	...
	<div class="cart-footer">
		...
		<div class="col-sm-4">
			<div class="total"><?=GetMessage("SALE_TOTAL")?> <span><?=str_replace(" ", "&nbsp;", $arResult["allSum_FORMATED"])?></span></div>
		</div>
		<div class="col-sm-4">
			...
			<a href="javascript:void(0)" onclick="checkOut();" class="btn btn-primary btn-cart"><?=GetMessage("SALE_ORDER")?></a>
		</div>
