...
<div class="nav-title"><?=$arResult["NavTitle"]?> 
...
<div class="nav-page">
	...
	<?if ($arResult["NavPageNomer"] > 1):?>
		...
		<?if($arResult["bSavePage"]):?>
			<a class="start-page" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=1"></a>
			<a class="prev-page" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>"></a>
		<?else:?>
			<a class="start-page" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"></a>
	...
	<?while($arResult["nStartPage"] <= $arResult["nEndPage"]):?>
		...
		<?if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
			<span class="cur-page"><?=$arResult["nStartPage"]?></span>
		<?elseif($arResult["nStartPage"] == 1 && $arResult["bSavePage"] == false):?>
			<a class="num-page" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><?=$arResult["nStartPage"]?></a>
		<?else:?>
			<a class="num-page" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["nStartPage"]?>"><?=$arResult["nStartPage"]?></a>
		<?endif?>
		<?$arResult["nStartPage"]++?>
	<?endwhile?>
	...
	<?if($arResult["NavPageNomer"] < $arResult["NavPageCount"]):?>
		...
		<a class="end-page" href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["NavPageCount"]?>"></a>
	<?else:?>
