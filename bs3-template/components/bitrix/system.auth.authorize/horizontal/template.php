...
<?endif?>
	...
	<form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>" class="form-horizontal">
		...
		<div class="form-group">
			<label for="userPassword" class="col-sm-2 control-label"><?=GetMessage("AUTH_PASSWORD")?></label>
			<div class="col-sm-10">
		...
		<div class="form-group">
			<label for="userCaptcha" class="col-sm-2 control-label"><?echo GetMessage("AUTH_CAPTCHA_PROMT")?></label>
			<div class="col-sm-10">
