...
<div class="bx_ordercart">
	<div class="bx_ordercart_order_table_container cart-page">
				...
				<tbody>
					...
					*/
					...
					?>
						<tr>
							<td class="custom_t1 fwb" colspan="<?=$colspan?>" class="itog"><?=GetMessage("SOA_TEMPL_SUM_IT")?></td>
							<td class="custom_t2 fwb" class="price"><div class="total"><span><?=$arResult["ORDER_TOTAL_PRICE_FORMATED"]?></span></div></td>
						</tr>
					<?
					endif;
					?>
